...
import com.yfl.util.helper.MacAddressProvider;
...
public class TimeBasedUuid {
    ...
    // We only use bottom 3 bytes for the sequence number. Paranoia: init with random int so that if JVM/OS/machine goes
    // down, clock slips
