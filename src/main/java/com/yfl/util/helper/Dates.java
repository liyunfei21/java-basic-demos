...
public class Dates {
	...
	public static class DateHelper {
		...
		public String asTimeString(){
			return asString("yyyy-MM-dd HH:mm:ss");
		}
		
		public String asDayString(){
		...
		public DateHelper week(int delta){
			m_cal.add(Calendar.WEEK_OF_YEAR, delta);
			return this;
		}
